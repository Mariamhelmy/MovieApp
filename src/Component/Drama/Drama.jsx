...
export default function Drama() {
    ...
    async function actionMov(){
        let api=await axios.get(`https://api.themoviedb.org/3/discover/movie?api_key=71749aa39f938e11d83ba4ddb2d93c73&with_genres=18&language=en-US`)
       console.log(api.data);
       setDramaMovie(api.data.results);
